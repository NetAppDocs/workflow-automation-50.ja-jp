...
|===
次の表に、 Data Center Manager サーバで開く必要があるデフォルトのポートを示します。
...
受信
 a| 
6.0 より前の Active IQ Data Center Manager からデータをキャッシュしています
...
受信
 a| 
Active IQ Data Center Manager 6.0 以降からのデータのキャッシュ
...
受信
 a| 
6.0 より前の Active IQ Data Center Manager に含まれている Performance Advisor からデータをキャッシュしています
